...
public class MenuPrincipalActivity extends Activity implements OnItemClickListener{
	...
	String values[]={"Gestionar Venta","Gestionar Productos","Gestionar Vales","Gestionar Clientes","Gestionar Gasolinera"};
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		String values2[]={"RegistrarVentaActivity","ProductosActivity","ValesActivity",
